...
import com.au.planningalerts.qr.camera.CameraSource;
import com.au.planningalerts.qr.camera.CameraSourcePreview;
...
public final class BarcodeCaptureActivity extends AppCompatActivity implements BarcodeGraphicTracker.BarcodeUpdateListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mResolver = getIntent().getParcelableExtra(Resolver);
        ...
        Snackbar.make(mGraphicOverlay, "Hover camera over Domain property QR code. Pinch/Stretch to zoom",
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        BarcodeTrackerFactory barcodeFactory = new BarcodeTrackerFactory(mGraphicOverlay, this, mResolver);
        ...
        // Creates and starts the camera.  Note that this uses a higher resolussson in comparison
        // to other detection examples to enable the barcode detector to detect small barcodes
        // at long distances.
